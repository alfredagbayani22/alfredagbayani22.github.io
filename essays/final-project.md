...
* New user goes to the landing page, logs in, sees the map, and sets up their profile
* Admin goes to the landing page, logs in, and edits the site
* User gets notified about construction sites near them that may block certain roads
* User gets notified about the weather in a specific area

## Beyond the basics

After implementing the basic functionality, here are ideas for more advanced features:
* User gets asked a prompt about how they rate the application out of 5 stars
